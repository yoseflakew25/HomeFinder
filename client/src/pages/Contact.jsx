...
const Contact = () => {
  return (
    <section id="contact" className="relative p-32">
      <div className="absolute top-0 left-0 z-[-1] h-1/2 w-full bg-[#eff3f2] lg:h-[45%] xl:h-1/2"></div>
      <div className="container px-4">
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              className="wow fadeInUp rounded-lg bg-[#F9FAFB] py-10 px-8 shadow-testimonial sm:py-12 sm:px-10 md:p-[60px] lg:p-10 lg:py-12 lg:px-10 2xl:p-[60px]"
              data-wow-delay=".2s
                "
            >
              ...
              <form>
                ...
                <div className="mb-0">
                  <button className="self-center w-auto px-8 border-0 text-white text-lg btn hover:bg-secondary bg-primary hover:text-white">
                    Send Message
                  </button>
                </div>
              </form>
